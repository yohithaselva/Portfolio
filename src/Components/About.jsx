...
const About = () => {
  ...
  return (
    <div id='about' className="py-6 flex flex-col items-center gap-16 px-4 lg:px-20 xl:px-40">
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center lg:items-start">
        ...
        <div className="flex flex-col gap-12 lg:gap-16 text-center lg:text-left" data-aos="fade-left">
          {/* About Text */}
          <div className="flex flex-col gap-6 text-base md:text-lg lg:text-xl leading-relaxed font-medium">
            <p>
              I am passionate about web development, with hobbies centered around creativity and design. I am currently working towards becoming a MERN stack developer, and I am deeply committed to honing my skills in both front-end and back-end technologies.
            </p>
            <p>
  ...
  { logo: "https://cdn.jsdelivr.net/npm/simple-icons@v4/icons/tailwindcss.svg" }, // Added Tailwind CSS logo
  { logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" } // Added CSS logo
].map(({ logo }, idx) => (
  <div
    key={idx}
