...
const About = () => {
  return (
    <div id='about' className="py-6 flex flex-col items-center gap-16 px-4 lg:px-20 xl:px-40">
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
        ...
        <div className="flex flex-col gap-12 lg:gap-16">
          ...
          <div className="flex flex-col gap-6">
            {[
              { skill: "HTML & CSS", width: "w-1/2" },
              { skill: "React Js", width: "w-3/4" },
              { skill: "JavaScript", width: "w-2/3" },
              { skill: "Angular Js", width: "w-1/2" },
            ].map(({ skill, width }, idx) => (
              <div
                key={idx}
      ...
      {/* Statistics */}
      <div className="flex flex-col md:flex-row justify-around items-center gap-12 md:gap-0 w-full">
        {[
